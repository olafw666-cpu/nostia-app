...
class Vault {
  ...
  static getTripSummary(tripId, userId = null) {
    ...
    return {
      ...
      balances: Object.values(balances).map(b => ({ id: b.userId, name: b.name, username: b.username, paid: b.paid, owes: b.owes, balance: b.balance })),
      entries,
      unpaidSplits
    };
  }
